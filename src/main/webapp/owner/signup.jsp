    ...
    <div class="row align-items-center">
        <div class="col d-flex justify-content-center">
            ...
            <span id="admin-select" type="button" data-bs-toggle="modal"
                  data-bs-target="#staticBackdrop" class="badge shifted text-bg-light">판매자 회원</span>
                ...
                <div class="card-body">
                    ...
                    <form action="signup.do" method="post">
                        ...
                        <div class="mb-3 form-check mb-3">
                            ...
                            <a href="${path}/check/findPass.do?authority=owner" class="card-link find_password">비밀번호을
                                잊으셨나요?</a>
                        </div>
        ...
        <div class="col d-flex justify-content-center">
            <div class="card shadow-lg" style="width: 25rem;">
                <div class="card-body">
                    ...
                    <form action="${path}/owner/signup.do" method="post">
