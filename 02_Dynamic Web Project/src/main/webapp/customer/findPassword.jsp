  ...
  <script>
    $(() => {
      ...
      $("#goToSignUp").on("click", function () {
        window.location.href = contextPath + "/customer/signup.do#signUpSection"
      });

      $("#reFindPass").on("click", function () {
        window.location.href = contextPath + "/check/findPass.do?authority=customer"
      });
    });
  </script>
    ...
    <div class="col d-flex justify-content-center">
      <div class="card shadow-lg" style="width: 25rem;">
        <div class="card-body">
          ...
          <form action="${path}/check/findPass.do" method="post">
            ...
            <div class="d-grid gap-2 col-12 mx-auto">
              <input hidden="hidden" name="authority" value="customer"/>
        ...
        <div id="others">
          <ul class="find_wrap">
            <li>
              이미 회원이시라면<a href="../customer/signup.do" class="card-link singin transition-link">로그인 해주세요!</a>
            </li>
            <li>
              아직회원이 아니시라면<a href="../customer/signup.do#signUpSection" class="card-link singup transition-link">우리의
              멤버가
              되어주세요!</a>
            </li>
          </ul>
